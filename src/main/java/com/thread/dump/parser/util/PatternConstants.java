...
public class PatternConstants {
	...
	public static final Pattern THREAD_NAME_MATCHER = Pattern.compile("^\"(.*)\".*\\stid=(\\w*) nid=(\\w*)\\s\\w*");

	public static final Pattern RUNNABLE_THREAD_SUFFIX_MATCHER = Pattern.compile("runnable\\s{1,2}$");

	public static final Pattern WAITING_ON_SUFFIX_MATCHER = Pattern.compile("waiting on condition\\s{1,2}$");
